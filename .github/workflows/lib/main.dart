...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleContextScrollView(
        child: Column(
          children:: double.infinity,
                height: 50,
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xFF1E88E5),
...
class SingleContextScrollView extends StatelessWidget {
  final Widget child;
  const SingleContextScrollView({super.key, required this.child});
